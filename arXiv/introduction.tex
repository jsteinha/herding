...
\begin{theorem}
\label{thm:main}
Given vector spaces $\V$ and $\W$\fTBD{JHH: hmm...you've switched from $\reals^{d}$ to vector spaces}, let $h : \W \to \bR$ be a convex function and let $f : \V \times \W \to \reals$ be a function 
such that
\begin{enumerate}
