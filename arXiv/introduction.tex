...
of $\|\cdot\|$.
\end{theorem}
This result is tight in the following sense:\fTBD{JS: can we generalize this to arbitrary norms? or some norms other than $\ell_{2}$?}\fTBD{JHH: rewrite to explicitly give $f$ and $S$}
\begin{theorem}
...
\item (JH) Application: Low-rank matrix approximation, approximation of SDP matrix sums 
